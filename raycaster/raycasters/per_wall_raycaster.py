...
class PerWallRaycaster(Raycaster):
    ...
    def render_walls(self):
        ...
        for ray in self.rays:
            ...
            if start_ray.map_coordinate[start_ray.hit_direction] != ray.map_coordinate[start_ray.hit_direction] or \
                    start_ray.map_coordinate[ray.hit_direction] != ray.map_coordinate[ray.hit_direction]:
